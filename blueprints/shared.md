# Blueprint: Shared Layer

This module contains the shared package configuration and the "Source of Truth" for data validation and API contracts.
...
### 3. Shared Validation (`shared/validation.ts`)
```typescript
import { z } from 'zod';
